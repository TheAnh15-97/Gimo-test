...
class Router
{
    ...
    /**
     * Send current request to registered middlewares of matched route.
     *
     * @param array $route
     * @return $this
     */
    public function sendToMiddlewares(array $route): Router
    {
        foreach (array_get($route, 'middlewares', []) as $middleware) {
